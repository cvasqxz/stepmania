...
### In Progress
- [x] Removed arch-build.sh script (not needed - use manual configure)
- [ ] Complete remaining C-style casts (Priority 3.4) - 341 occurrences in lower-priority files

### Not Started
- [ ] Security fixes (Windows-only files: archutils/Win32/GotoURL.cpp, archutils/Win32/Crash.cpp)
- [ ] **Priority 4: STL Modernization**
  - [ ] 4.1: CString → std::string (~1,163 occurrences)
  - [x] **4.2: Range-based for loops** (2026-03-05) - 21 FOREACH macros converted
  - [ ] 4.3: STL algorithms (std::find, std::transform, etc.)
  - [ ] 4.4: emplace_back instead of push_back (~697 occurrences)
- [ ] Priority 5: Threading (pthreads → std::thread)
- [ ] Priority 6: Architecture (singletons → dependency injection)
- [ ] Priority 7: Graphics (VBO, shaders, OpenGL modernization)
- [ ] SDL 2.0 migration
