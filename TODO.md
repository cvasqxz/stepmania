...
- ✅ Batch 25: RageUtil::WcharDisplayText, FixSlashes; Preference::PrefsGroupToString; Win32 utilities: FindSystemFile, GetPrimaryVideoName, GetPrimaryVideoDriverName
- ✅ Batch 26: XmlFile::XENTITYS::Ref2Entity/Entity2Ref, XRef2Entity/XEntity2Ref; MovieTexture_DShow::GetActiveFilterList
- ✅ Batch 27: AttackDisplay::GetAttackPath, EnumHelper::GetThemedString, ThemeManager::ClassAndElementToFileName, RageDisplay_D3D::GetErrorString, BeginnerHelper::GetAnimPath, ScreenHowToPlay::GetAnimPath, Song::RemoveInitialWhitespace, ArchHooks_Unix::LibcVersion, StepMania::GetVideoDriverName, test_file_readers::MakeTextTestLine
- ✅ Batch 28: CryptManager::BinaryToHex, RageFileDriverDirect::MakeTempFilename, RageSoundDriver_CA::FormatToString, MovieTexture_DShow::FourCCToString
- ✅ Batch 29: RageFileManager::GetDirOfExecutable, Song::GetSongAssetPath (with CString wrapper for CollapsePath calls)

**Final Status (2026-04-08, Batches 1-29 COMPLETE - 33/40 estimated, 82.5%):** ~3 CString-returning function definitions remain in src/*.h (down from ~130+ at start). Remaining are: ThemeManager protected internals (GetPathToAndFallback, GetPathToRaw, GetThemeDirFromName, GetMetricsIniPath, GetLanguageIniPath — intentionally kept, internal-only), XmlFile entity helpers (XENTITYS::Ref2Entity/Entity2Ref/XRef2Entity/XEntity2Ref — kept due to CString member assignment complexity), CryptManager::Sign (dead code, no implementation). ssprintf/vssprintf/hr_ssprintf/werr_ssprintf intentionally kept as CString until sm_crash overload is added.
