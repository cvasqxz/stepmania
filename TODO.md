...
### In Progress
- [x] **Priority 3.4: C-style casts** (2026-03-05) - 🔨 In Progress
  ...
  - Total converted: ~38 of 341 remaining (11% complete)
  - Next: ProfileManager.cpp (19), RageSurfaceUtils_Palettize.cpp (23), and more Screen files
...
- 🔨 **Priority 3.4**: C-style casts → static_cast (~38 conversions in 2 batches)
