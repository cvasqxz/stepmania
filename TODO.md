...
### In Progress
- [x] **Priority 3.4: C-style casts** (2026-03-18) - 🔨 In Progress (83.3% complete)
  ...
  - Total converted: 284 of 341 remaining (83.3% complete)
  - Next: Continue with remaining files (57 casts left)
...
- 🔨 **Priority 3.4**: C-style casts → modern C++ casts (284 conversions in 13 batches, 83.3% complete)
- ✅ **Batch 13 (2026-03-18)**: 36 conversions in 15 files including Direct3D, OpenGL, file drivers, sound readers
